...
namespace CodeSmile.Luny.DefaultContext
{
	public struct Lua_UnityEngine_LayerMask : ILuaUserData
	{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.LayerMask.GetHashCode", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.LayerMask.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_LayerMask>();
	...
	public sealed class Lua_UnityEngine_LayerMask_static : ILuaUserData
	{
		...
		private static readonly LuaFunction _LayerToName = new("UnityEngine.LayerMask.LayerToName", (_context, _buffer, _) =>
		{
			System.Int32 layer;
		...
		private static readonly LuaFunction _NameToLayer = new("UnityEngine.LayerMask.NameToLayer", (_context, _buffer, _) =>
		{
