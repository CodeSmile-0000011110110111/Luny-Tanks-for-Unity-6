...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_CanvasGroup : ILuaUserData
	{
		...
		private static readonly LuaFunction _BroadcastMessage = new("UnityEngine.CanvasGroup.BroadcastMessage", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _CompareTag = new("UnityEngine.CanvasGroup.CompareTag", (_context, _buffer, _) =>
		{
			System.String tag;
		...
		private static readonly LuaFunction _GetComponentIndex = new("UnityEngine.CanvasGroup.GetComponentIndex", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasGroup>();
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.CanvasGroup.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasGroup>();
		...
		private static readonly LuaFunction _GetInstanceID = new("UnityEngine.CanvasGroup.GetInstanceID", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasGroup>();
		...
		private static readonly LuaFunction _SendMessage = new("UnityEngine.CanvasGroup.SendMessage", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _SendMessageUpwards = new("UnityEngine.CanvasGroup.SendMessageUpwards", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.CanvasGroup.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasGroup>();
