...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_Awaitable : ILuaUserData
	{
		...
		private static readonly LuaFunction _Cancel = new("UnityEngine.Awaitable.Cancel", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.Awaitable.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Awaitable>();
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.Awaitable.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Awaitable>();
