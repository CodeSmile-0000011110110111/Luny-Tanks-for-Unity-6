...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_CreateAssetMenuAttribute : ILuaUserData
	{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.CreateAssetMenuAttribute.GetHashCode", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _IsDefaultAttribute = new("UnityEngine.CreateAssetMenuAttribute.IsDefaultAttribute", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CreateAssetMenuAttribute>();
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.CreateAssetMenuAttribute.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CreateAssetMenuAttribute>();
