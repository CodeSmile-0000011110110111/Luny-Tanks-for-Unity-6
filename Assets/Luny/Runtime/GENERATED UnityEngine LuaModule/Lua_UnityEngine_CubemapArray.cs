...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_CubemapArray : ILuaUserData
	{
		...
		private static readonly LuaFunction _Apply = new("UnityEngine.CubemapArray.Apply", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.CubemapArray.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CubemapArray>();
		...
		private static readonly LuaFunction _GetInstanceID = new("UnityEngine.CubemapArray.GetInstanceID", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CubemapArray>();
		...
		private static readonly LuaFunction _IncrementUpdateCount = new("UnityEngine.CubemapArray.IncrementUpdateCount", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CubemapArray>();
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.CubemapArray.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CubemapArray>();
