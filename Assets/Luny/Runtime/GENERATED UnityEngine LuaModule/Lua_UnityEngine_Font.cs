...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_Font : ILuaUserData
	{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.Font.GetHashCode", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _GetInstanceID = new("UnityEngine.Font.GetInstanceID", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Font>();
		...
		private static readonly LuaFunction _HasCharacter = new("UnityEngine.Font.HasCharacter", (_context, _buffer, _) =>
		{
			System.Char c;
		...
		private static readonly LuaFunction _RequestCharactersInTexture = new("UnityEngine.Font.RequestCharactersInTexture", (_context, _buffer, _) =>
		{
			...
			switch (argCount)
			{
				case 1:
				{
					if (arg1.TryRead<System.String>(out characters))
					{
				...
				{
					if (arg1.TryRead<System.String>(out characters) &&
					    arg2.TryRead<System.Int32>(out size))
					{
						_this.m_Instance.RequestCharactersInTexture(characters, size);
						return new ValueTask<Int32>(0);
					}
					throw new LuaRuntimeException(_context.State.GetTraceback(), "parameter type mismatch");
				}
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.Font.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Font>();
	...
	public sealed class Lua_UnityEngine_Font_static : ILuaUserData
	{
		...
		private static readonly LuaFunction _CreateDynamicFontFromOSFont = new("UnityEngine.Font.CreateDynamicFontFromOSFont", (_context, _buffer, _) =>
		{
			...
			switch (argCount)
			{
				case 2:
				{
					if (arg0.TryRead<System.String>(out fontname) &&
					    arg1.TryRead<System.Int32>(out size))
					{
						var returnValue = UnityEngine.Font.CreateDynamicFontFromOSFont(fontname, size);
						_buffer.Span[0] = new Lua_UnityEngine_Font(returnValue);
						return new ValueTask<Int32>(1);
					}
					throw new LuaRuntimeException(_context.State.GetTraceback(), "parameter type mismatch");
				}
		...
		private static readonly LuaFunction _GetMaxVertsForString = new("UnityEngine.Font.GetMaxVertsForString", (_context, _buffer, _) =>
		{
			System.String str;
			...
			switch (argCount)
			{
				case 1:
				{
					if (arg0.TryRead<System.String>(out str))
					{
