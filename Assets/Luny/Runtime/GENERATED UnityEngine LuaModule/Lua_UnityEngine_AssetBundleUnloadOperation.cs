...
{
	public class Lua_UnityEngine_AssetBundleUnloadOperation : ILuaUserData
	{
		...
		internal static LuaValue TryGetValue(Lua_UnityEngine_AssetBundleUnloadOperation instance, String key, LuaFunctionExecutionContext context)
		{
			switch (key)
			{
		...
		internal static LuaValue TrySetValue(Lua_UnityEngine_AssetBundleUnloadOperation instance, String key, LuaValue value, LuaFunctionExecutionContext context)
		{
			switch (key)
			{
		...
		public LuaTable Metatable
		{
			...
			set => throw new NotSupportedException("Lua_UnityEngine_AssetBundleUnloadOperation Metatable not assignable");
		}

		public static implicit operator LuaValue(Lua_UnityEngine_AssetBundleUnloadOperation v) => new(v);
	...
	public sealed class Lua_UnityEngine_AssetBundleUnloadOperation_static : ILuaUserData
	{
		...
		internal static LuaValue TryGetValue(Lua_UnityEngine_AssetBundleUnloadOperation_static instance, String key, LuaFunctionExecutionContext context)
		{
			switch (key)
			{
				default: throw new LunyBindingException(instance, key, context, BindingType.Getter);
		...
		internal static LuaValue TrySetValue(Lua_UnityEngine_AssetBundleUnloadOperation_static instance, String key, LuaValue value, LuaFunctionExecutionContext context)
		{
			switch (key)
			{
				default: throw new LunyBindingException(instance, key, context, BindingType.Setter);
		...
		{
			get => s_MetaTable ??= LunyMetatable.Create(__index, __newindex);
			set => throw new NotSupportedException("Lua_UnityEngine_AssetBundleUnloadOperation_static Metatable not assignable");
		}

		public static implicit operator LuaValue(Lua_UnityEngine_AssetBundleUnloadOperation_static v) => new(v);
	}
