...
namespace CodeSmile.Luny.DefaultContext
{
	public struct Lua_UnityEngine_DrivenRectTransformTracker : ILuaUserData
	{
		...
		private static readonly LuaFunction _Clear = new("UnityEngine.DrivenRectTransformTracker.Clear", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.DrivenRectTransformTracker.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_DrivenRectTransformTracker>();
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.DrivenRectTransformTracker.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_DrivenRectTransformTracker>();
	...
	public sealed class Lua_UnityEngine_DrivenRectTransformTracker_static : ILuaUserData
	{
		...
		private static readonly LuaFunction _StartRecordingUndo = new("UnityEngine.DrivenRectTransformTracker.StartRecordingUndo", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
		...
		private static readonly LuaFunction _StopRecordingUndo = new("UnityEngine.DrivenRectTransformTracker.StopRecordingUndo", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
