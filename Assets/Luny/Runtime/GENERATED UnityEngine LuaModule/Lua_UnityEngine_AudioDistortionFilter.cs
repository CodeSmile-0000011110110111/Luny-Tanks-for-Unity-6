...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_AudioDistortionFilter : ILuaUserData
	{
		...
		private static readonly LuaFunction _BroadcastMessage = new("UnityEngine.AudioDistortionFilter.BroadcastMessage", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _CompareTag = new("UnityEngine.AudioDistortionFilter.CompareTag", (_context, _buffer, _) =>
		{
			System.String tag;
		...
		private static readonly LuaFunction _GetComponentIndex = new("UnityEngine.AudioDistortionFilter.GetComponentIndex", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_AudioDistortionFilter>();
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.AudioDistortionFilter.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_AudioDistortionFilter>();
		...
		private static readonly LuaFunction _GetInstanceID = new("UnityEngine.AudioDistortionFilter.GetInstanceID", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_AudioDistortionFilter>();
		...
		private static readonly LuaFunction _SendMessage = new("UnityEngine.AudioDistortionFilter.SendMessage", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _SendMessageUpwards = new("UnityEngine.AudioDistortionFilter.SendMessageUpwards", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.AudioDistortionFilter.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_AudioDistortionFilter>();
