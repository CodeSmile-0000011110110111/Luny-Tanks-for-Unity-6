...
namespace CodeSmile.Luny.DefaultContext
{
	public struct Lua_UnityEngine_BackgroundThreadAwaitable : ILuaUserData
	{
		...
		private static readonly LuaFunction _GetAwaiter = new("UnityEngine.BackgroundThreadAwaitable.GetAwaiter", (_context, _buffer, _) =>
		{
			...
			switch (argCount)
			{
				case 0:
				{
						...
						_buffer.Span[0] = new Lua_UnityEngine_BackgroundThreadAwaitable(returnValue);
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.BackgroundThreadAwaitable.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_BackgroundThreadAwaitable>();
		...
		private static readonly LuaFunction _GetResult = new("UnityEngine.BackgroundThreadAwaitable.GetResult", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_BackgroundThreadAwaitable>();
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.BackgroundThreadAwaitable.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_BackgroundThreadAwaitable>();
