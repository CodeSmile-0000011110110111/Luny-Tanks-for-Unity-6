...
namespace CodeSmile.Luny.DefaultContext
{
	public struct Lua_UnityEngine_GradientAlphaKey : ILuaUserData
	{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.GradientAlphaKey.GetHashCode", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.GradientAlphaKey.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_GradientAlphaKey>();
