...
namespace CodeSmile.Luny.DefaultContext
{
	public struct Lua_UnityEngine_Cache : ILuaUserData
	{
		...
		private static readonly LuaFunction _ClearCache = new("UnityEngine.Cache.ClearCache", (_context, _buffer, _) =>
		{
			...
			switch (argCount)
			{
				...
				case 1:
				{
					if (arg1.TryRead<System.Int32>(out expiration))
					{
						var returnValue = _this.m_Instance.ClearCache(expiration);
						_buffer.Span[0] = new LuaValue(returnValue);
						return new ValueTask<Int32>(1);
					}
		...
		private static readonly LuaFunction _Equals = new("UnityEngine.Cache.Equals", (_context, _buffer, _) =>
		{
			UnityEngine.Cache other;
			Lua_UnityEngine_Cache other_UserData;
			...
			switch (argCount)
			{
				case 1:
				{
					if (arg1.TryRead<Lua_UnityEngine_Cache>(out other_UserData))
					{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.Cache.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Cache>();
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.Cache.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Cache>();
