...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_AssemblyIsEditorAssembly : ILuaUserData
	{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.AssemblyIsEditorAssembly.GetHashCode", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _IsDefaultAttribute = new("UnityEngine.AssemblyIsEditorAssembly.IsDefaultAttribute", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_AssemblyIsEditorAssembly>();
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.AssemblyIsEditorAssembly.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_AssemblyIsEditorAssembly>();
