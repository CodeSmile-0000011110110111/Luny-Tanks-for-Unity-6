...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_CanvasRenderer : ILuaUserData
	{
		...
		private static readonly LuaFunction _BroadcastMessage = new("UnityEngine.CanvasRenderer.BroadcastMessage", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _Clear = new("UnityEngine.CanvasRenderer.Clear", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasRenderer>();
		...
		private static readonly LuaFunction _CompareTag = new("UnityEngine.CanvasRenderer.CompareTag", (_context, _buffer, _) =>
		{
			System.String tag;
		...
		private static readonly LuaFunction _DisableRectClipping = new("UnityEngine.CanvasRenderer.DisableRectClipping", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasRenderer>();
		...
		private static readonly LuaFunction _GetAlpha = new("UnityEngine.CanvasRenderer.GetAlpha", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasRenderer>();
		...
		private static readonly LuaFunction _GetComponentIndex = new("UnityEngine.CanvasRenderer.GetComponentIndex", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasRenderer>();
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.CanvasRenderer.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasRenderer>();
		...
		private static readonly LuaFunction _GetInheritedAlpha = new("UnityEngine.CanvasRenderer.GetInheritedAlpha", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasRenderer>();
		...
		private static readonly LuaFunction _GetInstanceID = new("UnityEngine.CanvasRenderer.GetInstanceID", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasRenderer>();
		...
		private static readonly LuaFunction _SendMessage = new("UnityEngine.CanvasRenderer.SendMessage", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _SendMessageUpwards = new("UnityEngine.CanvasRenderer.SendMessageUpwards", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _SetAlpha = new("UnityEngine.CanvasRenderer.SetAlpha", (_context, _buffer, _) =>
		{
			System.Single alpha;
			...
			switch (argCount)
			{
				case 1:
				{
					if (arg1.TryRead<System.Single>(out alpha))
					{
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.CanvasRenderer.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CanvasRenderer>();
