...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_CompositeCollider2D : ILuaUserData
	{
		...
		private static readonly LuaFunction _BroadcastMessage = new("UnityEngine.CompositeCollider2D.BroadcastMessage", (context, buffer, ct) =>
		{
		...
		private static readonly LuaFunction _CompareTag = new("UnityEngine.CompositeCollider2D.CompareTag", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CompositeCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _GenerateGeometry = new("UnityEngine.CompositeCollider2D.GenerateGeometry", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CompositeCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _GetComponentIndex = new("UnityEngine.CompositeCollider2D.GetComponentIndex", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CompositeCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.CompositeCollider2D.GetHashCode", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CompositeCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _GetInstanceID = new("UnityEngine.CompositeCollider2D.GetInstanceID", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CompositeCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _GetPathPointCount = new("UnityEngine.CompositeCollider2D.GetPathPointCount", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CompositeCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _GetShapeHash = new("UnityEngine.CompositeCollider2D.GetShapeHash", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CompositeCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _IsTouchingLayers = new("UnityEngine.CompositeCollider2D.IsTouchingLayers", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CompositeCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _SendMessage = new("UnityEngine.CompositeCollider2D.SendMessage", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CompositeCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _SendMessageUpwards = new("UnityEngine.CompositeCollider2D.SendMessageUpwards", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CompositeCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.CompositeCollider2D.ToString", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CompositeCollider2D>();
			var argCount = context.ArgumentCount;
