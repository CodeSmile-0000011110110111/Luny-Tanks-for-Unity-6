...
namespace CodeSmile.Luny.DefaultContext
{
	public struct Lua_UnityEngine_ContactPair : ILuaUserData
	{
		...
		private static readonly LuaFunction _GetContactPointFaceIndex = new("UnityEngine.ContactPair.GetContactPointFaceIndex", (_context, _buffer, _) =>
		{
			System.Int32 contactIndex;
			...
			switch (argCount)
			{
				case 1:
				{
					if (arg1.TryRead<System.Int32>(out contactIndex))
					{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.ContactPair.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_ContactPair>();
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.ContactPair.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_ContactPair>();
