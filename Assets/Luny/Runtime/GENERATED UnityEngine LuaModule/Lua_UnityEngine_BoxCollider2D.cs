...
{
	public class Lua_UnityEngine_BoxCollider2D : ILuaUserData
	{
		...
		internal static LuaValue TryGetValue(Lua_UnityEngine_BoxCollider2D instance, String key, LuaFunctionExecutionContext context)
		{
			switch (key)
			{
		...
		internal static LuaValue TrySetValue(Lua_UnityEngine_BoxCollider2D instance, String key, LuaValue value, LuaFunctionExecutionContext context)
		{
			switch (key)
			{
		...
		public LuaTable Metatable
		{
			...
			set => throw new NotSupportedException("Lua_UnityEngine_BoxCollider2D Metatable not assignable");
		}

		public static implicit operator LuaValue(Lua_UnityEngine_BoxCollider2D v) => new(v);
	...
	public sealed class Lua_UnityEngine_BoxCollider2D_static : ILuaUserData
	{
		...
		internal static LuaValue TryGetValue(Lua_UnityEngine_BoxCollider2D_static instance, String key, LuaFunctionExecutionContext context)
		{
			switch (key)
			{
				default: throw new LunyBindingException(instance, key, context, BindingType.Getter);
		...
		internal static LuaValue TrySetValue(Lua_UnityEngine_BoxCollider2D_static instance, String key, LuaValue value, LuaFunctionExecutionContext context)
		{
			switch (key)
			{
				default: throw new LunyBindingException(instance, key, context, BindingType.Setter);
		...
		{
			get => s_MetaTable ??= LunyMetatable.Create(__index, __newindex);
			set => throw new NotSupportedException("Lua_UnityEngine_BoxCollider2D_static Metatable not assignable");
		}

		public static implicit operator LuaValue(Lua_UnityEngine_BoxCollider2D_static v) => new(v);
	}
