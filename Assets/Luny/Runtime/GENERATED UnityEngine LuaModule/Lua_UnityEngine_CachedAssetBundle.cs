...
namespace CodeSmile.Luny.DefaultContext
{
	public struct Lua_UnityEngine_CachedAssetBundle : ILuaUserData
	{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.CachedAssetBundle.GetHashCode", (context, buffer, ct) =>
		{
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.CachedAssetBundle.ToString", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CachedAssetBundle>();
			var argCount = context.ArgumentCount;
