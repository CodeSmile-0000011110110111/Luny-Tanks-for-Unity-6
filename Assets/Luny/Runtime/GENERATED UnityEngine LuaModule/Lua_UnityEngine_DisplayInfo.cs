...
namespace CodeSmile.Luny.DefaultContext
{
	public struct Lua_UnityEngine_DisplayInfo : ILuaUserData
	{
		...
		private static readonly LuaFunction _Equals = new("UnityEngine.DisplayInfo.Equals", (_context, _buffer, _) =>
		{
			UnityEngine.DisplayInfo other;
			Lua_UnityEngine_DisplayInfo other_UserData;
			...
			switch (argCount)
			{
				case 1:
				{
					if (arg1.TryRead<Lua_UnityEngine_DisplayInfo>(out other_UserData))
					{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.DisplayInfo.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_DisplayInfo>();
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.DisplayInfo.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_DisplayInfo>();
