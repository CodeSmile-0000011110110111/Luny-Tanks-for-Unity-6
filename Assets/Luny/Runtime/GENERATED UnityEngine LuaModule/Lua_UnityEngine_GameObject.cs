...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_GameObject : ILuaUserData
	{
		...
		private static readonly LuaFunction _BroadcastMessage = new("UnityEngine.GameObject.BroadcastMessage", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _CompareTag = new("UnityEngine.GameObject.CompareTag", (_context, _buffer, _) =>
		{
			System.String tag;
		...
		private static readonly LuaFunction _GetComponentCount = new("UnityEngine.GameObject.GetComponentCount", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_GameObject>();
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.GameObject.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_GameObject>();
		...
		private static readonly LuaFunction _GetInstanceID = new("UnityEngine.GameObject.GetInstanceID", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_GameObject>();
		...
		private static readonly LuaFunction _SendMessage = new("UnityEngine.GameObject.SendMessage", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _SendMessageUpwards = new("UnityEngine.GameObject.SendMessageUpwards", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _SetActive = new("UnityEngine.GameObject.SetActive", (_context, _buffer, _) =>
		{
			...
			switch (argCount)
			{
				case 1:
				{
					if (arg1.TryRead<System.Boolean>(out value))
					{
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.GameObject.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_GameObject>();
	...
	public sealed class Lua_UnityEngine_GameObject_static : ILuaUserData
	{
		...
		private static readonly LuaFunction _Find = new("UnityEngine.GameObject.Find", (_context, _buffer, _) =>
		{
			System.String name;
			...
			switch (argCount)
			{
				case 1:
				{
					if (arg0.TryRead<System.String>(out name))
					{
						...
						_buffer.Span[0] = new Lua_UnityEngine_GameObject(returnValue);
						return new ValueTask<Int32>(1);
					}
					throw new LuaRuntimeException(_context.State.GetTraceback(), "parameter type mismatch");
				}
		...
		private static readonly LuaFunction _FindGameObjectWithTag = new("UnityEngine.GameObject.FindGameObjectWithTag", (_context, _buffer, _) =>
		{
			System.String tag;
		...
		private static readonly LuaFunction _FindWithTag = new("UnityEngine.GameObject.FindWithTag", (_context, _buffer, _) =>
		{
			System.String tag;
