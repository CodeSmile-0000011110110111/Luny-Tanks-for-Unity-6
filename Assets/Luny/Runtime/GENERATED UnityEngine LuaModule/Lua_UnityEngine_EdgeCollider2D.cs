...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_EdgeCollider2D : ILuaUserData
	{
		...
		private static readonly LuaFunction _BroadcastMessage = new("UnityEngine.EdgeCollider2D.BroadcastMessage", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _CompareTag = new("UnityEngine.EdgeCollider2D.CompareTag", (_context, _buffer, _) =>
		{
			System.String tag;
		...
		private static readonly LuaFunction _GetComponentIndex = new("UnityEngine.EdgeCollider2D.GetComponentIndex", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_EdgeCollider2D>();
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.EdgeCollider2D.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_EdgeCollider2D>();
		...
		private static readonly LuaFunction _GetInstanceID = new("UnityEngine.EdgeCollider2D.GetInstanceID", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_EdgeCollider2D>();
		...
		private static readonly LuaFunction _GetShapeHash = new("UnityEngine.EdgeCollider2D.GetShapeHash", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_EdgeCollider2D>();
		...
		private static readonly LuaFunction _IsTouchingLayers = new("UnityEngine.EdgeCollider2D.IsTouchingLayers", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _Reset = new("UnityEngine.EdgeCollider2D.Reset", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_EdgeCollider2D>();
		...
		private static readonly LuaFunction _SendMessage = new("UnityEngine.EdgeCollider2D.SendMessage", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _SendMessageUpwards = new("UnityEngine.EdgeCollider2D.SendMessageUpwards", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.EdgeCollider2D.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_EdgeCollider2D>();
