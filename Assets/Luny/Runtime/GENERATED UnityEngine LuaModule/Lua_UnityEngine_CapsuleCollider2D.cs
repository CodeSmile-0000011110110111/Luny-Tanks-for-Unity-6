...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_CapsuleCollider2D : ILuaUserData
	{
		...
		private static readonly LuaFunction _BroadcastMessage = new("UnityEngine.CapsuleCollider2D.BroadcastMessage", (context, buffer, ct) =>
		{
		...
		private static readonly LuaFunction _CompareTag = new("UnityEngine.CapsuleCollider2D.CompareTag", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CapsuleCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _GetComponentIndex = new("UnityEngine.CapsuleCollider2D.GetComponentIndex", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CapsuleCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.CapsuleCollider2D.GetHashCode", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CapsuleCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _GetInstanceID = new("UnityEngine.CapsuleCollider2D.GetInstanceID", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CapsuleCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _GetShapeHash = new("UnityEngine.CapsuleCollider2D.GetShapeHash", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CapsuleCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _IsTouchingLayers = new("UnityEngine.CapsuleCollider2D.IsTouchingLayers", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CapsuleCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _SendMessage = new("UnityEngine.CapsuleCollider2D.SendMessage", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CapsuleCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _SendMessageUpwards = new("UnityEngine.CapsuleCollider2D.SendMessageUpwards", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CapsuleCollider2D>();
			var argCount = context.ArgumentCount;
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.CapsuleCollider2D.ToString", (context, buffer, ct) =>
		{
			var arg0 = context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_CapsuleCollider2D>();
			var argCount = context.ArgumentCount;
