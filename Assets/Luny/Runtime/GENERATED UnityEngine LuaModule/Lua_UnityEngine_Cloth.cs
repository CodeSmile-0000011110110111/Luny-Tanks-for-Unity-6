...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_Cloth : ILuaUserData
	{
		...
		private static readonly LuaFunction _BroadcastMessage = new("UnityEngine.Cloth.BroadcastMessage", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _ClearTransformMotion = new("UnityEngine.Cloth.ClearTransformMotion", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Cloth>();
		...
		private static readonly LuaFunction _CompareTag = new("UnityEngine.Cloth.CompareTag", (_context, _buffer, _) =>
		{
			System.String tag;
		...
		private static readonly LuaFunction _GetComponentIndex = new("UnityEngine.Cloth.GetComponentIndex", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Cloth>();
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.Cloth.GetHashCode", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Cloth>();
		...
		private static readonly LuaFunction _GetInstanceID = new("UnityEngine.Cloth.GetInstanceID", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Cloth>();
		...
		private static readonly LuaFunction _SendMessage = new("UnityEngine.Cloth.SendMessage", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _SendMessageUpwards = new("UnityEngine.Cloth.SendMessageUpwards", (_context, _buffer, _) =>
		{
			System.String methodName;
		...
		private static readonly LuaFunction _SetEnabledFading = new("UnityEngine.Cloth.SetEnabledFading", (_context, _buffer, _) =>
		{
			System.Boolean enabled;
			System.Single interpolationTime;
			...
			switch (argCount)
			{
				...
				{
					if (arg1.TryRead<System.Boolean>(out enabled) &&
					    arg2.TryRead<System.Single>(out interpolationTime))
					{
						_this.m_Instance.SetEnabledFading(enabled, interpolationTime);
						return new ValueTask<Int32>(0);
					}
					throw new LuaRuntimeException(_context.State.GetTraceback(), "parameter type mismatch");
				}
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.Cloth.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Cloth>();
