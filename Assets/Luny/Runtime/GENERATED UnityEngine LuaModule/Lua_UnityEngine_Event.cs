...
namespace CodeSmile.Luny.DefaultContext
{
	public class Lua_UnityEngine_Event : ILuaUserData
	{
		...
		private static readonly LuaFunction _GetHashCode = new("UnityEngine.Event.GetHashCode", (_context, _buffer, _) =>
		{
		...
		private static readonly LuaFunction _ToString = new("UnityEngine.Event.ToString", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Event>();
		...
		private static readonly LuaFunction _Use = new("UnityEngine.Event.Use", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
			var arg0 = _context.GetArgument(0);
			var _this = arg0.Read<Lua_UnityEngine_Event>();
	...
	public sealed class Lua_UnityEngine_Event_static : ILuaUserData
	{
		...
		private static readonly LuaFunction _GetEventCount = new("UnityEngine.Event.GetEventCount", (_context, _buffer, _) =>
		{
			var argCount = _context.ArgumentCount;
		...
		private static readonly LuaFunction _KeyboardEvent = new("UnityEngine.Event.KeyboardEvent", (_context, _buffer, _) =>
		{
			System.String key;
			...
			switch (argCount)
			{
				case 1:
				{
					if (arg0.TryRead<System.String>(out key))
					{
						...
						_buffer.Span[0] = new Lua_UnityEngine_Event(returnValue);
						return new ValueTask<Int32>(1);
					}
		...
		private static readonly LuaFunction _PopEvent = new("UnityEngine.Event.PopEvent", (_context, _buffer, _) =>
		{
			UnityEngine.Event outEvent;
			Lua_UnityEngine_Event outEvent_UserData;
			...
			switch (argCount)
			{
				case 1:
				{
					if (arg0.TryRead<Lua_UnityEngine_Event>(out outEvent_UserData))
					{
						outEvent = outEvent_UserData.Instance;
