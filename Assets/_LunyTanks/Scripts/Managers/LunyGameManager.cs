...
namespace CodeSmile.Luny.Tanks
{
	public sealed class LunyGameManager : LunyScript
	{
		...
		//       private LunyTankManager m_RoundWinner;          // Reference to the winner of the current round.  Used to make an announcement of who won.
		//       private LunyTankManager m_GameWinner;           // Reference to the winner of the game.  Used to make an announcement of who won.
		//
		...
		//           var textRef = FindAnyObjectByType<LunyMessageTextReference>(FindObjectsInactive.Include);
		//
		...
		//               var mov = m_SpawnPoints[i].m_Instance.GetComponent<LunyTankMovement>();
		...
		//       private LunyTankManager GetRoundWinner()
		//       {
		//           // Go through all the tanks...
		//           for (int i = 0; i < m_PlayerCount; i++)
		//           {
		...
		//       private LunyTankManager GetGameWinner()
		//       {
		//           // Go through all the tanks...
		//           for (int i = 0; i < m_PlayerCount; i++)
		//           {
