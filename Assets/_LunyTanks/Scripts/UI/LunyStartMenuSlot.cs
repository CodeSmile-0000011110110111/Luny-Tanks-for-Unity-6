...
namespace CodeSmile.Luny.Tanks
{
	...
	public sealed class LunyStartMenuSlot : LunyScript
	{
        ...
        public void SetTankPreview(GameObject prefab)
        {
            ...
            var move = TankPreview.GetComponent<LunyTankMovement> ();
            var shoot = TankPreview.GetComponent<LunyTankShooting> ();
            var health = TankPreview.GetComponent<LunyTankHealth>();
