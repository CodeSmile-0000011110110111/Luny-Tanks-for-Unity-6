...
{
	public sealed class LunyTankAI : LunyScript
	{
        ...
        private LunyTankMovement m_Movement;                // Reference to the movement script
        private LunyTankShooting m_Shooting;                // Reference to the shooting script
        ...
        //         return;
        //
        //     m_Movement = GetComponent<LunyTankMovement>();
        //     m_Shooting = GetComponent<LunyTankShooting>();
        //
        ...
        //     m_AllTanks = FindObjectsByType<LunyTankMovement>(FindObjectsInactive.Exclude, FindObjectsSortMode.None).Select(e => e.gameObject).ToArray();
        // }
        //
